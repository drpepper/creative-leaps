...
function update(timeScale) {
  ...
  if (requestedTransition != null) {
    var nextSceneName = util.provideNextScene(sceneTransitions, currentSceneName, requestedTransition);
...
var IntroScene = function (_util$Entity) {
  _inherits(IntroScene, _util$Entity);
  ...
  _createClass(IntroScene, [{
    ...
    value: function setup() {
      ...
      this.done = false;
      document.getElementById("done-intro").addEventListener("click", function (e) {
        return _this2.done = true;
      });
    }
  }, {
    key: "teardown",
...
var TrainingScene = function (_util$Entity2) {
  _inherits(TrainingScene, _util$Entity2);

  function TrainingScene() {
    _classCallCheck(this, TrainingScene);

    return _possibleConstructorReturn(this, (TrainingScene.__proto__ || Object.getPrototypeOf(TrainingScene)).apply(this, arguments));
  }

  _createClass(TrainingScene, [{
    key: "setup",
    value: function setup() {
      var _this4 = this;
...
var BlockScene = function (_util$Entity3) {
  _inherits(BlockScene, _util$Entity3);

  function BlockScene() {
    _classCallCheck(this, BlockScene);

    return _possibleConstructorReturn(this, (BlockScene.__proto__ || Object.getPrototypeOf(BlockScene)).apply(this, arguments));
  }

  _createClass(BlockScene, [{
    key: "setup",
    value: function setup() {
      this.done = false;
    ...
    value: function update(timeSinceStart) {
      ...
      try {
        for (var _iterator = this.highlightedBlocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var color = util.cyclicLerpColor(BLOCK_COLOR, HIGHLIGHTED_BLOCK_COLOR, timeSinceStart % DRAG_HIGHLIGHT_PERIOD / DRAG_HIGHLIGHT_PERIOD);
    ...
    value: function updateTargetBlockContainerPosition() {
      ...
      var minBlockPos = util.min.apply(null, oldBlockPositions);
      var maxBlockPos = util.max.apply(null, oldBlockPositions);
      var blockCenterPos = util.average(minBlockPos, maxBlockPos);
    ...
    value: function dropBlock(block, droppedPos) {
      ...
      var closestGridPos = _.min(freeGridPositions, function (freePos) {
        return util.distance(gridPos, freePos);
      });
    ...
    value: function canMoveBlock(gridPos) {
      var blocksWithout = util.removeFromArray(this.blockGrid, gridPos);
    ...
    value: function onAddShape() {
      var galleryShape = util.cloneData(this.blockGrid);
    ...
    value: function onAttemptDone() {
      if (galleryShapes.length < 5) document.getElementById("end-early-message").style.display = "block";else document.getElementById("modal-confirm-done").style.display = "block";
    }
  }, {
    key: "cancelModal",
...
var GalleryScene = function (_util$Entity4) {
  _inherits(GalleryScene, _util$Entity4);

  function GalleryScene() {
    _classCallCheck(this, GalleryScene);

    return _possibleConstructorReturn(this, (GalleryScene.__proto__ || Object.getPrototypeOf(GalleryScene)).apply(this, arguments));
  }

  _createClass(GalleryScene, [{
    key: "setup",
    value: function setup() {
      var _this7 = this;
      ...
      var _loop = function _loop(i) {
        var page = Math.floor(i / ITEMS_PER_PAGE);
        ...
        var galleryShapeCenter = new PIXI.Point(70 + col * 90, 90 + row * 90);
      ...
      document.getElementById("done-selection").addEventListener("click", function (e) {
        return _this7.done = true;
      });
    ...
    value: function onToggleShape(shape, shapeIndex) {
      ...
      if (isSelected) this.selectedIndexes.push(shapeIndex);else this.selectedIndexes = util.removeFromArray(this.selectedIndexes, shapeIndex);
...
var ResultsScene = function (_util$Entity5) {
  _inherits(ResultsScene, _util$Entity5);

  function ResultsScene() {
    _classCallCheck(this, ResultsScene);

    return _possibleConstructorReturn(this, (ResultsScene.__proto__ || Object.getPrototypeOf(ResultsScene)).apply(this, arguments));
  }
...
},{"./util.js":329,"babel-polyfill":2,"url-search-params-polyfill":328}],2:[function(require,module,exports){
(function (global){
"use strict";
...
module.exports.average = function () {
  ...
  try {
    for (var _iterator4 = points[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      sum = module.exports.add(sum, point);
    }
  } catch (err) {
    _didIteratorError4 = true;
    _iteratorError4 = err;
...
module.exports.moveTowards = function (a, b, speed) {
  var d = module.exports.distanceBetween(a, b);
...
module.exports.difference = function (array) {
  ...
  return _.filter(array, function (value) {
    return !module.exports.contains(rest, value);
  });
};
...
module.exports.resizeGame = function (app) {
  ...
  var scale = Math.min(parentSize.x / app.renderer.width, parentSize.y / app.renderer.height).toFixed(2);
  ...
  document.getElementById("game-container").style.transform = "scale(" + scale + ") translate(" + (remainingSpace.x / 2).toFixed(2) + "px, " + (remainingSpace.y / 2).toFixed(2) + "px)";
};
...
module.exports.centerContainer = function (container, centerPos) {
  ...
  var minBlockPos = module.exports.min.apply(null, oldBlockPositions);
  var maxBlockPos = module.exports.max.apply(null, oldBlockPositions);
  var blockCenterPos = module.exports.average(minBlockPos, maxBlockPos);
  var offset = module.exports.subtract(centerPos, blockCenterPos);

  container.position = offset;
};

module.exports.Entity = function (_PIXI$utils$EventEmit) {
  _inherits(_class, _PIXI$utils$EventEmit);
...
module.exports.StateMachine = function (_module$exports$Entit) {
  _inherits(_class2, _module$exports$Entit);

  function _class2(states, transitions) {
...
module.exports.ParallelEntities = function (_module$exports$Entit2) {
  _inherits(_class3, _module$exports$Entit2);
...
},{"url-search-params-polyfill":328}]},{},[1]);
